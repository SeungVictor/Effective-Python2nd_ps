...
바뀐 상속관계 속에서 *\_\_value* 속성을 _MyClass_ 가 아닌 _MyBaseClass_ 에서 할당한다. 그러면 처음 사용했던 _MyIntegerSubclass_ 의 비공개 변수 참조인 _self.\_MyClass\_\_value_ 가 이제는 존재하지 않기 때문에 동작하지 않는다.
